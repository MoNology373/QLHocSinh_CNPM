...
CREATE TABLE `class_teacher` (
  ...
  `teacher_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci NOT NULL,
  ...
  CONSTRAINT `class_teacher_ibfk_2` FOREIGN KEY (`teacher_name`) REFERENCES `teacher` (`userName`)
...
INSERT INTO `class_teacher` VALUES (1,'nha'),(2,'nha'),(4,'nha'),(5,'nha'),(6,'nha'),(9,'nha'),(1,'thinh'),(3,'thinh'),(6,'thinh'),(7,'thinh'),(8,'thinh'),(9,'thinh');
